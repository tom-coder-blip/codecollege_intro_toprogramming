...
document.getElementById("myData").addEventListener("click", thisMyProfit)

let profitForTheWeek = 0;
...
// Function to display the weekly profit when the button is clicked
function thisMyProfit() {
    alert("Your profit this week is $" + profitForTheWeek);
    console.log("Displayed Weekly Profit: $" + profitForTheWeek);
}
